...
export function RecentTranscriptions() {
  ...
  const [selectedTranscription, setSelectedTranscription] = useState<typeof recentTranscriptions[0] | null>(null);
  const [modalOpen, setModalOpen] = useState(false);

  const handleViewTranscription = (item: typeof recentTranscriptions[0]) => {
