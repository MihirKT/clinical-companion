...
export function PatientDemographicsPage() {
  ...
  const patientVisits = mockVisits.filter(
                ...
                {selectedPatient.alerts &&
                  selectedPatient.alerts.length > 0 && (
                    <Badge variant="severity-high" className="gap-1">
                      ...
                      {selectedPatient.alerts.length} Alert
                      {selectedPatient.alerts.length > 1 ? "s" : ""}
                    </Badge>
                  )}
              </div>
                  ...
                  <>
                    <div className="p-4 rounded-lg bg-muted/50">
                      ...
                      <p className="text-2xl font-semibold text-foreground">
                        {mockVitals[0].bloodPressureSystolic}/
                        {mockVitals[0].bloodPressureDiastolic}
